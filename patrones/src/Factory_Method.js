...
function paellaVegetariana(){
    ...
    var paellaGetProduct = new paellaProduct(); 
    var ingredientesVegetariana = ["zanahoria", "pimenton", "tomate", "raices"];
    return new paellaGetProduct.product(ingredientesVegetariana);
}

function paellaCarne(){

    var paellaGetProduct = new paellaProduct(); 
    var ingredientescarnePollo = ["pollo", "pimenton", "tomate", "carneroja"];
    return new paellaGetProduct.product(ingredientescarnePollo);
}
